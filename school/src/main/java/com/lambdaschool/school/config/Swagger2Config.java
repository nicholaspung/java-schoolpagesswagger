...
public class Swagger2Config
{
    ...
    {
        return new ApiInfoBuilder().title("School Assignment")
                .description("Project for Swagger UI")
                .contact(new Contact("Nicholas Pung", "http://www.lambdaschool.com", "nicholas@lambdaschool.com"))
